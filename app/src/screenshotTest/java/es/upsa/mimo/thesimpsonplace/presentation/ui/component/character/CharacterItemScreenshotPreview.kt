...
// ############# Video de referencia de Antonio en Youtube: https://www.youtube.com/watch?v=w-Iu_-sl9n8 y web: https://devexpert.io/screenshot-testing-compose/ #############
// 1. Para ejecutar y se cree el ScreenShot en la terminal:  ./gradlew updateDebugScreenshotTest
// 2. Para ver los screenshots generados: app/src/debug/screenshotsTest/.../character/CharacterItemScreenshotPreview/CharacterItemScreenshotPreview.png
...
// 4. Comprobar el resultado del test en app/build/reports/screenshotTests/preview/...index.html y le damos a 'open in' en el navegador (Browser)
...
// 6. Si la ultima imagen es la que queremos guardar, realizamos el punto 1. para que se actualice el screenshot y lo guardemos.
